export function heroContent(){
    ...
    searchContainer.setAttribute('class','search-container w-50 d-flex flex-column justify-content-center align-items-center ms-3');
    
    const content = {
        headline: function(){
            const headline = headlineContainer.appendChild(document.createElement('h2'));
        ...
        search: function(){
            ...
            input.setAttribute('class','search-input form-control w-100 rounded bg-opacaity-50 fs-4 border-3 border-black');
            input.setAttribute('placeholder', 'One Piece');
        },
        buttons: function(){
            const buttonsContainer = searchContainer.appendChild(document.createElement('div'));
            buttonsContainer.setAttribute('class', 'buttons-container w-100 h-25 pt-1');
